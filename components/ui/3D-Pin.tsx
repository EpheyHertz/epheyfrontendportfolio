...
"use client"; // Ensures this file is only used on the client side
...
// Dynamic component, only renders on the client
const PinContainer = ({
  children,
  title,
  href,
  ...
  if (!isClient) return null; // Prevents SSR rendering until client hydration
