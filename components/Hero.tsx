...
const Hero = () => {
  return (
    ...
    <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.04] bg-grid-black/[0.2] flex items-center justify-center 
  ...
  <div className='flex justify-center relative my-20 z-10'>
    ...
    lg:max-w-[60vw] flex flex-col items-center justify-center'>
        ...
        text-blue-100 max-w-80'>
            Dynamic Show With Next Js skills
        </h2>
       <TextGenerateEffect
       ...
       mb-4 text-sm md:text-lg lg:text-2xl '>
        Hi, I&apos;m Ephey.Hope you are doing well!Welcome to my Portfolio.Am a Backend Engineer and am happy to have you onboard.
       </p>
       <a href="#about">
        <MagicButton
        title='Show My work'
